...
impl ModelManager {
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                description: "NVIDIA Parakeet — fast, accurate English ASR with punctuation."
                    .to_string(),
                filename: "parakeet-tdt-0.6b-v2-int8".to_string(), // Directory name
                // TODO: still hosted on the upstream Handy CDN — these int8 ONNX bundles
                // are custom-packaged and have no official mirror. Re-host before a
                // public launch.
    ...
    pub fn get_available_models(&self) -> Vec<ModelInfo> {
        ...
        result.sort_by(|a, b| match (a.is_custom, b.is_custom) {
