...
use crate::feedback_sounds::SoundType;
...
#[tauri::command]
#[specta::specta]
pub async fn play_feedback_preview(app: AppHandle, sound_type: String, sound_id: String) {
    ...
    audio_feedback::play_feedback_preview(&app, sound, sound_id);
}
