...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "text-black bg-logo-primary border-transparent hover:bg-logo-primary/85 focus:ring-1 focus:ring-logo-primary shadow-[0_1px_2px_rgba(0,0,0,0.15)]",
    "primary-soft":
      "text-text bg-logo-primary/20 border-transparent hover:bg-logo-primary/30 focus:ring-1 focus:ring-logo-primary",
    secondary:
      "bg-mid-gray/10 border-mid-gray/20 hover:bg-mid-gray/20 hover:border-mid-gray/30 focus:outline-none",
    danger:
